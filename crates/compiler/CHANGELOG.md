...
## [0.0.17](https://github.com/tachish/farm/compare/farmfe_compiler-v0.0.16...farmfe_compiler-v0.0.17) - 2025-03-15

### Fixed

- #2103 and resource pot id hash conflicts ([#2107](https://github.com/tachish/farm/pull/2107))
- persistent cache panic when using addFileWatchFile with query #2067 ([#2068](https://github.com/tachish/farm/pull/2068))
