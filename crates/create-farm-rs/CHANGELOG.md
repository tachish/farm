...
## [0.1.6](https://github.com/tachish/farm/compare/create-farm-v0.1.5...create-farm-v0.1.6) - 2025-03-15

### Added

- *(create)* add support for tauri 2 ([#2001](https://github.com/tachish/farm/pull/2001))

### Fixed

- *(template)* Missing dev dependency react-refresh on TauriJS ([#2115](https://github.com/tachish/farm/pull/2115))

### Other

- update template versions ([#2110](https://github.com/tachish/farm/pull/2110))
